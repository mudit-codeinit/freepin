<?php 
    ...
    $product = getProduct(4437307359337);
    // getProducts("post_upsell")
                ...
                <div class="row justify-content-center">
                    <div class="col-md-9 text-center">
                        <h2 class="BigTxt txt_primary margin_B">
                            I Have An Exclusive 1 Time ONLY Deal For You
                        </h2>
                    </div>
                    <div class="col-md-11 text-center markingHigh margin_B">
                        <h4>
                            <!-- Grab 10 Piece Bundle for an incredible 1 time Discount of 75% OFF Today! -->
                            Grab Trump Face Hat 1 time Discount of 50% OFF Today!
                        </h4>
                    </div>
                        ...
                        <div class="row justify-content-around align-items-center  margin_B">
                            ...
                            <div class="col-sm-9 col-md-6">
                                <form id="form2" class="swatch_view_form" action="core/core.php" method="POST"> 
                                    ...
                                    <input type="hidden" name="action" value="upsell1-submit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <ul class="swatch-view-part">
                                                <?php foreach ($option['values'] as $key => $value) { 
                                                    if($key==0){
                                                        $active = 'active';
                                                        $src = "https://cdn.shopify.com/s/files/1/0263/9111/7929/products/Webp.net-resizeimage_48_1024x1024_2x_9309cedd-c9a8-49e8-a8d6-c52fabe4c689.jpg?v=1576221495";
                                                    }elseif($key==1){
                                                        $active = '';
                                                        $src = "https://cdn.shopify.com/s/files/1/0263/9111/7929/products/Webp.net-resizeimage_56_1024x1024_2x_3544a69e-d948-4b61-882d-fba6df12f1d1.jpg?v=1576221496";
                                                    }elseif($key==2){
                                                        $active = '';
                                                        $src = "https://cdn.shopify.com/s/files/1/0263/9111/7929/products/Webp.net-resizeimage_53_1024x1024_2x_5d37f6b7-c4bb-4d9e-8891-fff9e9e2ccaa.jpg?v=1576221496";
                                                    } else{
                                                        $active = '';
                                                        $src = "https://cdn.shopify.com/s/files/1/0263/9111/7929/products/Webp.net-resizeimage_48_1024x1024_2x_9309cedd-c9a8-49e8-a8d6-c52fabe4c689.jpg?v=1576221495";
                                                    }
                                            ...
                                            <!--<ul class="swatch-view-part">
                                                 <?php /*foreach ($option['values'] as $key => $value) { ?>
                                                    <li class="swatch-view-item-part" onchange="productOptionSelect(<?php echo $value;?>, <?php echo $product['id'];?>)">
                                    ...
                                    <button id="payButton" type="button" class="btn upSell_Btn">
                                        Yes! Add this Amazing Trump Face Hat to my shipment today for $14.95 ($14.95 Total)
                                        <span class="">Because the 50% Discount is activated for next 5 mins....</span>
                                    </button>

                                </form>

                                <a href="core/core.php?action=upsell1-skip" class="dontNeed_Btn">I Don't Need This Right Now</a>
                            </div>
                        </div>

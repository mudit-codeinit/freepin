...
<section class="shipping-page-bg" style="background: url('assets/images/free-pin-bg.jpg')">
<div class="row shipping-page-design justify-content-center grayBG">
        ...
        <div class="col-md-12 text-center">
            ...
            <div class="row zoomImg justify-content-center">
                <div class="show col-6" href="assets/images/mainProduct.webp">
        ...
        <div class="col-md-12">
            <div class="product-detail-price">
                <h3>*Supplies are very limited. We have a strict limit of 10 per customer.*</h3>
                <div class="row">
                <div class="col-6">
                ...
                <div class="col-md-12">
                    <div class="products-list">
                        <ul>
                            <li class="bestDeal">
                                <span class="prods_name">
                                    <div class="radio">
                                        <input onclick="addProduct1(4399053504617, 31390446813289,1, 7.95)" type="radio" name="quentaty" class="qty" value="1" id="retailPrice_1"  checked="">
                                        <label for="radio-1" onclick='radioClickFunc("retailPrice_1");' class="radio-label" >1 FREE Trump Train Pin (Retail $14.95)</label>
                                    </div>
                                </span>
                                <p class="prods_price">$7.95 S&H</p>
                            </li>
                            <li>
                                <span class="prods_name">
                                    <div class="radio">
                                        <input onclick="addProduct1(4399053504617, 31390446813289, 2, 6.95)" type="radio"  name="quentaty" class="qty" value="2" id="retailPrice_2">
                                        <label for="radio-2"  onclick='radioClickFunc("retailPrice_2");' class="radio-label" >2 FREE Trump Train Pins (Retail $29.9)</label>
                                    </div>
                                </span>
                                <p class="prods_price">$6.95 S&H/Each</p>
                            </li>
                            <li >
                                <span class="prods_name">
                                    <div class="radio">
                                        <input onclick="addProduct1(4399053504617, 31390446813289, 5, 5.95)" type="radio" name="quentaty" class="qty" value="5" id="retailPrice_3">
                                        <label for="radio-3" onclick='radioClickFunc("retailPrice_3");' class="radio-label"  >  5 FREE Trump Train Pins (Retail $74.75)</label>
                                    </div>
                                </span>
                                <p class="prods_price">$5.95 S&H/Each </p>
                            </li>
                            <li>
                                <span class="prods_name">
                                    <div class="radio">
                                        <input onclick="addProduct1(4399053504617, 31390446813289, 10, 4.95)" type="radio" name="quentaty" class="qty" value="10" id="retailPrice_4">
                                        <label for="radio-4"  onclick='radioClickFunc("retailPrice_4");' class="radio-label"> 10 FREE Trump Train Pins (Retail $149.5)  </label>
                                    </div>
                                </span>
                                <p class="prods_price">$4.95 S&H/Each </p>
                            </li>
                        </ul>
                    </div>
                </div>
                    <div class="shipping-payment-detail">
            ...
            <div class="row">
                            ...
                            <input class="form-control " name="email" required="" value="" type="email" placeholder="Email Address..." >
						...
						<div class="row">
							<div class="col-md-12">
								<h4><span>Step 2:</span> Shipping Address</h4>
							</div>
							<div class="col-md-12 input-group">
          ...
          <form id="form2" class="yourInfo_form" action="core/core.php" method="POST">
                        <input type="hidden" name="action" value="place_order">
                          ...
                          <input   type="hidden" name="quentaty" id="quentaty" value="1">

						<div class="row">
							<div class="col-md-12">
								<h4><span>Step 3:</span> Payment Info</h4>
							</div>
            						...
            						<div class="col-12 formBox">
            							<div id="checkout-products" class="col-12 itemSelected">
            							...
            							<div class="formBox">
            								<div class="col-11 shopping_Line">
            									...
            									<div class="clearfix shopping_LineHead">
            										...
            										<label for="<?php echo $p['id']; ?>"  style="font-size: 1rem; padding: 5px;">
      ...
      function isNumberKeyWithSlash(evt)
      {
		...
		function stripeResponseHandler(status, response) {
		    if (response.error) {
		        ...
		        // form$.get(0).submit();
            console.log('inside form2submit');
                $("#loading-indicator").show();
                  $("#form2").submit();
                  return false;
          ...
          console.log('payButton clicked');
                ...
                if(payment_type=="paypal"){
                  ...
                  //
                   ...
                   console.log('credit card inside');
                  var firstName = '',  shippingAddress1 ='', shippingZip ='', shippingCity ='', shippingState ='', email ='', phone = '';
                  ...
                  if(check_status==1)
                  {
                    console.log('inside check_status');
                    $("#error_handler_overlay").show();
                    return false;
                  }
                  else
                  {
                    console.log('inside form1 submit');
